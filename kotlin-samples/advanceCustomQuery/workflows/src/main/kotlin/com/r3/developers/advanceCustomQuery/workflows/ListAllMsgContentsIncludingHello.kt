...
class ListAllMsgContentsIncludingHello : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        log.info("ListAllMsgContentsIncludingHello.call() called")

        //this is our custom query
        val resultSet = ledgerService.query("GET_ALL_MSGS_CONTENT_HAS_HELLO", String::class.java)
