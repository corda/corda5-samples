...
```
{
    ...
    "flowClassName": "workflows.com.r3.developers.samples.referencestate.CreateNewChatFlow",
    "requestBody": {
...
```
{
    ...
    "flowClassName": "workflows.com.r3.developers.samples.referencestate.ListChatsFlow",
    "requestBody": {}
}
```
...
```
{
    ...
    "flowClassName": "workflows.com.r3.developers.samples.referencestate.UpdateChatFlow",
    "requestBody": {
        "id":" ** fill in id **",
...
```
{
    ...
    "flowClassName": "workflows.com.r3.developers.samples.referencestate.GetChatFlow",
    "requestBody": {
        "id":" ** fill in id **",
        "numberOfRecords":"4"
    }
