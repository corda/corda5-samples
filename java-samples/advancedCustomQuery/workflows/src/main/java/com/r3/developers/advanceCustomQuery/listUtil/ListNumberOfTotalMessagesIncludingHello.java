...
public class ListNumberOfTotalMessagesIncludingHello implements ClientStartableFlow {
    ...
    public String call(ClientRequestBody requestBody) {
        ...
        PagedQuery.ResultSet<Integer> resultSet = utxoLedgerService.query("GET_MSG_AMOUNT_HAS_HELLO", Integer.class)
