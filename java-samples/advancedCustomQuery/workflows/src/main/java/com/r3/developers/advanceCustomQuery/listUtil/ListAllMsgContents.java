...
public class ListAllMsgContents implements ClientStartableFlow {
    ...
    public String call(ClientRequestBody requestBody) {
        ...
        PagedQuery.ResultSet<String> resultSet = utxoLedgerService.query("GET_ALL_MSGS_CONTENT", String.class)
