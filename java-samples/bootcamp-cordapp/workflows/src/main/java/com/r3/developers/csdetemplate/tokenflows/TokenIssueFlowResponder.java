...
@InitiatedBy(protocol = "finalize-token-protocol")
public class TokenIssueFlowResponder implements ResponderFlow {
    private final static Logger log = LoggerFactory.getLogger(TokenIssueFlowResponder.class);
    ...
    public void call(FlowSession session) {
        ...
        log.info("TokenIssueFlowResponder.call() called");
