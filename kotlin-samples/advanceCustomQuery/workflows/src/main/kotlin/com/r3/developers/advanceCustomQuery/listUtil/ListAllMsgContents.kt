...
class ListAllMsgContents : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        log.info("ListAllMsgContents.call() called")

        //this is our custom query
        val resultSet = ledgerService.query("GET_ALL_MSGS_CONTENT", String::class.java)
