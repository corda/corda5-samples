...
- A UTXO example in package com.r3.developers.cordapptemplate.customJSON packages
...
```
{
    ...
    "flowClassName": "com.r3.developers.cordapptemplate.customJSON.workflows.CreateNewChatFlow",
    "requestBody": {
...
```
{
    ...
    "flowClassName": "com.r3.developers.cordapptemplate.customJSON.workflows.ListChatsFlow",
    "requestBody": {}
}
```
...
```
{
    ...
    "flowClassName": "com.r3.developers.cordapptemplate.customJSON.workflows.UpdateChatFlow",
    "requestBody": {
        "id":" ** fill in id **",
...
```
{
    ...
    "flowClassName": "com.r3.developers.cordapptemplate.customJSON.workflows.GetChatFlow",
    "requestBody": {
        "id":" ** fill in id **",
        "numberOfRecords":"4"
    }
