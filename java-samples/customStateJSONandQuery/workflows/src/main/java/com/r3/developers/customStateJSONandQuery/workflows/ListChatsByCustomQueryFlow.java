...
public class ListChatsByCustomQueryFlow implements ClientStartableFlow {
    ...
    public String call(ClientRequestBody requestBody) {
        ...
        PagedQuery.ResultSet<StateAndRef> resultSet = utxoLedgerService.query("GET_MSG_FROM", StateAndRef.class)
