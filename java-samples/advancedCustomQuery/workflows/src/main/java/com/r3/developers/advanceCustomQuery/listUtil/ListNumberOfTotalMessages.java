...
public class ListNumberOfTotalMessages implements ClientStartableFlow {
    ...
    public String call(ClientRequestBody requestBody) {
        ...
        PagedQuery.ResultSet<Integer> resultSet = utxoLedgerService.query("GET_MSG_AMOUNT", Integer.class)
