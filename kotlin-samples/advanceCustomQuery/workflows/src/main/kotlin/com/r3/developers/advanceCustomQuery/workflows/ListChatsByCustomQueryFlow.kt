...
class ListChatsByCustomQueryFlow : ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        val resultSet = ledgerService.query("GET_MSG_WITH_MORE_THAN_4_CHAR", StateAndRef::class.java)
...
RequestBody for triggering the flow via REST:
{
    ...
    "flowClassName": "com.r3.developers.advanceCustomQuery.workflows.ListChatsByCustomQueryFlow",
    "requestBody": {}
}
*/
